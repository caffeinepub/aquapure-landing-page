...
function StarRating({ rating, count: count2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex text-amber-400 text-lg", children: [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: s <= Math.floor(rating) ? "★" : s === Math.ceil(rating) ? "★" : "☆" }, s)) }),
...
function ReviewCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": `reviews.item.${index2}`,
      className: "rounded-xl bg-white p-3 flex flex-col gap-2 shadow-sm border border-slate-100",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-teal-100 flex items-center justify-center text-sm font-bold text-teal-700 flex-shrink-0", children: review.initials }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-slate-800", children: review.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400", children: review.date })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex text-amber-400 text-sm", children: "★".repeat(review.rating).split("").map((star, i) => (
            // biome-ignore lint/suspicious/noArrayIndexKey: star rating position is stable
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: star }, i)
          )) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-600 leading-relaxed", children: review.text })
      ]
    }
  );
}
function GoodUXPage() {
  ...
  const [selectedColor, setSelectedColor] = reactExports.useState(colorVariants[0].name);
  const [selectedSize, setSelectedSize] = reactExports.useState("750 ml");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-slate-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-white border-b border-slate-200 sticky top-0 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 h-10 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: "/",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Badge,
        {
          variant: "secondary",
          className: "bg-teal-50 text-teal-700 border-teal-200 text-xs",
          children: "Free shipping on orders over ₹499"
        }
      ) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-6xl mx-auto px-4 py-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 md:grid md:grid-cols-2 md:gap-8 md:items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "relative flex items-center justify-center rounded-2xl overflow-hidden cursor-zoom-in",
            style: {
              background: "radial-gradient(ellipse at center, #e0faf4 60%, #b2ead8 100%)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
                    inset: 0,
                    background: "radial-gradient(ellipse at 50% 60%, rgba(0,200,160,0.18) 0%, transparent 70%)",
                    pointerEvents: "none"
                  }
                }
              ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-teal-500 uppercase tracking-widest mb-1", children: "AquaPure" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-slate-800 leading-tight", children: "Stainless Steel Insulated Water Bottle – 750 ml" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { rating: 4.5, count: "1,200" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 mt-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold text-slate-800", children: "₹799" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base text-slate-400 line-through", children: "₹1,199" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-green-100 text-green-700 border-green-200 text-xs font-semibold", children: "33% OFF" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 mt-0.5", children: "Inclusive of all taxes" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium text-slate-700", children: [
              "Colour: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-teal-600", children: selectedColor })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: colorVariants.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  ...
                  border: selectedColor === c.name ? "3px solid #0d9488" : "2px solid #cbd5e1",
                  boxShadow: selectedColor === c.name ? "0 0 0 2px #ccfbf1" : "none"
                }
              },
              c.name
            )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium text-slate-700", children: [
              "Size: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-teal-600", children: selectedSize })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: sizeVariants.map((size) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  backgroundColor: selectedSize === size ? "#ccfbf1" : "white",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-slate-700", children: "Quantity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center border border-slate-200 rounded-lg overflow-hidden bg-white", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-4 py-2 text-sm font-semibold text-slate-800 min-w-[2.5rem] text-center", children: quantity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  "data-ocid": "quantity.button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                ...
                "ADD TO CART — ₹",
                (799 * quantity).toLocaleString("en-IN")
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-1.5", children: characteristics.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-teal-500 mt-0.5 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              DialogContent,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Return & Refund Policy" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl bg-slate-50 p-4 flex flex-col gap-3", children: [
                    {
                      icon: RotateCcw,
                  ...
                  ].map(({ icon: Icon2, title, body }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 mt-0.5 text-teal-500 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-slate-600", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-700", children: title }),
                      " ",
                      "— ",
                      body
                    ] })
                  ] }, title)) }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2 rounded-xl bg-white border border-slate-100 p-3 shadow-sm", children: trustBadges.map(({ icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex flex-col items-center gap-1 text-center",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-teal-500" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate-500 leading-tight", children: label })
              ]
            },
            label
          )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "reviews.section", className: "mt-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-slate-800", children: "Customer Reviews" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400 mt-0.5", children: "Based on 1,200 verified reviews" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { rating: 4.5, count: "1,200" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl bg-white border border-slate-100 p-4 mb-3 max-w-sm shadow-sm", children: [
          { stars: 5, pct: 72 },
          { stars: 4, pct: 18 },
          { stars: 3, pct: 6 },
          { stars: 2, pct: 2 },
          { stars: 1, pct: 2 }
        ].map(({ stars, pct }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-amber-400 w-6 text-right", children: [
            stars,
            "★"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-2 rounded-full overflow-hidden bg-slate-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-slate-400 w-8", children: [
            pct,
            "%"
          ] })
        ] }, stars)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: reviews.map((review, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCard, { review, index: i + 1 }, review.name)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-slate-200 py-4 mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-400", children: [
      "© ",
...
function PoorUXPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-white border-b border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 h-10 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-semibold text-gray-700", children: "AquaPure" }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-6xl mx-auto px-4 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 md:grid md:grid-cols-2 md:gap-6 md:items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-semibold text-gray-800", children: "Stainless Steel Insulated Water Bottle – 750ml" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 leading-snug", children: "Keeps drinks cold for 24 hours & hot for 12 hours thanks to double-wall insulation. Leakproof stainless steel design. BPA-free material. Lightweight and durable." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-gray-800", children: "₹799" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-400 line-through", children: "₹1,199" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-600", children: "Colour" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5", children: colorVariants.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setSelectedColor(c.name),
                ...
                style: {
                  backgroundColor: c.value,
                  border: selectedColor === c.name ? "2px solid #555" : "1px solid #ccc"
                }
              },
              c.name
            )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-600", children: "Size" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5", children: sizeVariants.map((size) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setSelectedSize(size),
                ...
                style: {
                  backgroundColor: selectedSize === size ? "#e5e7eb" : "white",
                  borderColor: "#d1d5db",
                  color: "#4b5563"
                },
                children: size
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-600", children: "Qty" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center border border-gray-200 rounded overflow-hidden bg-white", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => setQuantity((q) => Math.max(1, q - 1)),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-3 py-1.5 text-sm text-gray-700", children: quantity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => setQuantity((q) => Math.min(10, q + 1)),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md rounded-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Return & Refund Policy" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl bg-slate-50 p-4 flex flex-col gap-3", children: [
                {
                  icon: RotateCcw,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "w-full rounded-xl", children: "Close" }) }) })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-semibold text-gray-700 mb-2", children: "Customer Reviews" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3", children: reviews.map((review) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "rounded-lg bg-white p-3 flex flex-col gap-1 border border-gray-200",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-gray-200 flex items-center justify-center text-xs text-gray-600", children: review.initials }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-gray-700", children: review.name })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 leading-snug", children: review.text })
            ]
          },
          review.name
        )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-gray-200 py-4 mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      ". Built with ❤️ using",
      " ",
...
function App() {
  const [view, setView] = reactExports.useState("good");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { position: "top-right" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-1 bg-white border border-slate-200 rounded-full shadow-lg px-2 py-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          "data-ocid": "view.tab",
          className: `px-4 py-1.5 rounded-full text-sm font-medium transition-all ${view === "good" ? "bg-teal-600 text-white" : "text-slate-500 hover:text-slate-700"}`,
          children: "Good UX"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          "data-ocid": "view.tab",
          className: `px-4 py-1.5 rounded-full text-sm font-medium transition-all ${view === "poor" ? "bg-slate-700 text-white" : "text-slate-500 hover:text-slate-700"}`,
          children: "Poor UX"
        }
      )
    ] }),
    view === "good" ? /* @__PURE__ */ jsxRuntimeExports.jsx(GoodUXPage, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(PoorUXPage, {})
  ] });
}
